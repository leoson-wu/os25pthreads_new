...
if __name__ == '__main__':
	parser = argparse.ArgumentParser(description='Generate transformer C++ code from spec.')
	parser.add_argument('--input', default='./tests/00_spec.json', help='Input json file path.')
	parser.add_argument('--output', default='./transformer.cpp', help='Output .cpp file path.')
