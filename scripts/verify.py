...
if __name__ == '__main__':
	parser = argparse.ArgumentParser(description='Verify output against answer.')
	parser.add_argument('--output', default='./tests/00.ans', help='Output file path.')
	parser.add_argument('--answer', default='./tests/00.out', help='Answer file path.')
	args = parser.parse_args()

	verify(args.output, args.answer)
